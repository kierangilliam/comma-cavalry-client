/**
 * Forked from https://github.com/pavelkukov/q-floodfill
 * to add the option of supplying a color palette 
 * for better flood filling on arc edges (/pull/7)
 */

import {
    ColorRGBA, colorToRGBA, getColorAtPixel, isSameColor,
    setColorAtPixel
} from './color-utils'
