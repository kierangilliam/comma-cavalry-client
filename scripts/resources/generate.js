...
const SOURCE_FOLDER = 'scripts/resources'

const SOURCE_IOS_ICON = SOURCE_FOLDER + '/ios/icon/';
const SOURCE_IOS_SPLASH = SOURCE_FOLDER + '/ios/splash/';
...
const SOURCE_ANDROID_ICON = SOURCE_FOLDER + '/android/icon/';
const SOURCE_ANDROID_SPLASH = SOURCE_FOLDER + '/android/splash/';
